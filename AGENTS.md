...
`docs/solutions/` contains documented solutions and reusable learnings, organized by category with YAML frontmatter (`module`, `tags`, `problem_type`). It is relevant when implementing, debugging, or making decisions in documented areas.
